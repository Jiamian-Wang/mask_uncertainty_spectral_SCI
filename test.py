...
# GPU setting #################################################
parser.add_argument('--device',                   default='0,1',              help='CUDA ID(s)')
# directories #################################################
...
parser.add_argument("--last_train",    type=int,  default=661,    help='checkpoint epoch number. [661] for many-to-many, [662] for one-to-X')
...
ckpt_path = './' + args.mode + '/model_epoch_{}.pth'.format(args.last_train)
